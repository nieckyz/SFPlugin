...
SOURCES = \
	__init__.py \
	SFSharedLoader.py SFSharedLoader_dockwidget.py

PLUGINNAME = SFSharedLoader

PY_FILES = \
	__init__.py \
	SFSharedLoader.py SFSharedLoader_dockwidget.py

UI_FILES = SFSharedLoader_dockwidget_base.ui
...
QGISDIR=C:\Users\dicky\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
